...
Lecture and Lab &mdash; 8 hours/week in class and 2 hours/week online
...
***This is a four-credit course with laboratory in a six-week summer session. You should expect to spend, on average, 22 hours per week on this class.***
 In a normal (Fall or Spring) semester, the face-to-face version of this course would have an expectation of 11 hours per week of work: 3 hours of lecture/discussion, 2 hours of lab, and 6 hours of work outside the classroom reading the textbook, studying, doing assignments, working on projects, and practicing in order to master the concepts and techniques covered in the course. (See Definition of the Credit Hour)

In a six-week summer session, we cover two normal semester weeks of work in each summer session week, for a total of 22 hours per week: 6 hours of lecture/discussion, 4 hours of lab, and 12 hours of work outside class.

Since this class is a blended class (meeting face-to-face for only 8 hours per week on combined lecture/discussion and lab), you will spend an additional 2 hours on out-of-class work, bringing the out-of-class total to 14 hours per week. 
